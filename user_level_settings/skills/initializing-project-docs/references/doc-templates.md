...
Detailed content requirements for each document type generated by `/initializing-project-docs`. The skill's SKILL.md has the workflow and structure; this file has per-document specifics.
