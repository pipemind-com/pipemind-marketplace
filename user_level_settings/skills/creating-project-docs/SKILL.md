...
| workflow | Planner/builder agent pattern, main thread orchestration | `docs/workflow.md` |
...
**Optional**: Generated if planner/builder workflow detected. Referenced by main orchestration thread.
...
- Task tracking via native tools (TaskCreate/TaskUpdate/TaskList/TaskGet) in main thread
...
|-------|------------------------|------------------|
| **Planner** | `docs/architecture.md`, `docs/workflow.md`, `docs/tech-stack.md` | Component responsibilities, output format, tech constraints |
| **Builder** | `docs/architecture.md`, `docs/testing.md`, `docs/tech-stack.md` | Data flow, test commands, output format |
