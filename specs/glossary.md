...
**Research Session**
A problem directory (`<problem-slug>/`) containing the full state of a scientific method investigation: `problem.md`, `hypothesis-NN.md` files, `references.md`, `references/` downloads, and `findings.md`.
